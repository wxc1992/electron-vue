...
<div v-loading="loading">
    ...
    <div style="width:100%;text-align: center">
        <el-button class="commitBtn" type="primary" plain @click="submit(2)">提&nbsp;&nbsp;交</el-button>
        <el-button class="commitBtn" type="primary" plain @click="submit(7)">暂&nbsp;&nbsp;存</el-button>
    </div>
</div>
</template>
...
export default {
  ...
  computed: {
    ...
    moduleLevel() {
      this.inputLevel = this.getNewoutputContent.rowdata.gradeLevel;
      return this.getNewoutputContent.rowdata.gradeLevel;
    },
    zhibiaolist() {
  ...
  methods: {
    ...mapActions(['addNewCreatingComment', 'uploadBase64', 'modCreditSubjectLevel', 'getlevelReviewer']),
    ...
    getlevelReviewerData() {
      this.getlevelReviewer().then((res) => {
        ...
        this.reviewer = [res.data.data[0].userId];
    ...
    testChange() {
      ...
      //     if (this.changeForm[key] !== ''){
      //       arr.push(key)
      //     }
      //   }
      //     // this.$message.success('可以测试了')
      //     console.log('this.form',this.form)
      //     console.log('this.form2',this.form2)
      //     this.istest = true
      //     this.testmsg = this.testLoading
      //     let {
      //       plateValue: moduleId
      //     } = this.getCreditFilter;
      //     let subjectId = this.tabData.rowData.id;
      //     const param = {
      //       ...this.form,
      //       ...this.form2,
      //       moduleId,
    ...
    getsubList(val) {
      ...
      if (this.zhibiaolist.length > 0 && this.zhibiaolist !== null) {
    ...
    submit(type) {
      ...
      const compName = this.getNewoutputContent.rowdata.compName;
      const level = this.inputLevel;
      const gradeLevel = this.moduleLevel;
      const reviewer = this.reviewer;
      const status = +type;
      const moduleId = this.getNewoutputContent.rowdata.moduleId;
