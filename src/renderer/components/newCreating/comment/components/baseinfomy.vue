...
export default {
  ...
  computed: {
    outputVisibleMy() {
      ...
      if (show) {
        ...
        let arr = [];
        if (this.dioData.rowData.moduleId == 5035 || this.dioData.rowData.moduleId == 5035 || this.dioData.rowData.moduleId == 5036 || this.dioData.rowData.moduleId == 6001 || this.dioData.rowData.moduleId == 6002 || this.dioData.rowData.moduleId == 6003 || this.dioData.rowData.moduleId == 6004) {
          const {
            s_scale_level,
            s_industry_status,
            s_profitability,
        ...
        } else if (this.dioData.rowData.moduleId == 5053) {
          const {
            s_industry_status,
  ...
  watch: {
    outputVisibleMy(val) {
      debugger;
      console.log('baseInfo.calsbaseInfo.calsbaseInfo.calsbaseInfo.cals+++++++', val);
