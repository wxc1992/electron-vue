...
<div class="commentItem2">
    ...
    <div class="operate" v-if="needOperate">
        <el-button type="primary" plain @click="audit(3)" v-if="buttonRights['comment_pass']">通过</el-button>
        <el-button plain @click="audit(4)" v-if="buttonRights['comment_reject']">驳回</el-button>
        <el-button plain @click="audit(5)" v-if="buttonRights['comment_undo']">撤销</el-button>
    </div>
...
export default {
  ...
  props: ['singleItem', 'moduleType', 'majority'],
  methods: {
